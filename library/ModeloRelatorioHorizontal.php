...
class ModeloRelatorioHorizontal {
	//A4 210mm x 297mm	841.89 595.28
	private $pdfToClone;
	private $pageToClone;
	private $pdf;
	private $page;
	private $titleLine = 573;
	private $legendLine = 543;
	private $columnSpace = 5;
	private $firstLine = 528;
	private $lastLine = 40;
	private $columnRodape = 717;
	...
	public function __construct() {
		...
		$this->pdfToClone = Zend_Pdf::load('../library/templateRelatorio_horizontal.pdf');

		$this->pageToClone = new Zend_Pdf_Page(Zend_Pdf_Page::SIZE_A4_LANDSCAPE);
		...
		$this->page = new Zend_Pdf_Page(Zend_Pdf_Page::SIZE_A4_LANDSCAPE);
