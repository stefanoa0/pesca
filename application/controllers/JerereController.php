...
private $usuario;
    ...
    public function updatepesqueiroAction() {
        ...
        $this->modelJerere->updatePesqueiro($idEntrevistaPesqueiro, $idEntrevista, $pesqueiro, $tempoapesqueiro, $distanciapesqueiro);
    ...
    public function updateespeciecapturadaAction() {
        ...
        $this->modelJerere->updateEspCapturada($idEntrevistaEspecie,$idEntrevista, $especie, $quantidade, $peso, $preco);
        $this->redirect("/jerere/tableespcaptura/id/" . $idEntrevista);
        }
    ...
    public function updatebiopeixeAction() {
        ...
        $this->modelJerere->updateBioPeixe($idEntrevistaPeixe,$idEntrevista, $idEspecie, $sexo, $comprimento, $peso);
        //$this->redirect("/jerere/editar/id/" . $backUrl);
        $this->redirect("/jerere/tablebiopeixe/id/" . $idEntrevista);
        }
