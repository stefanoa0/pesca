...
class ColetaManualController extends Zend_Controller_Action
{
    ...
    public function visualizarAction() {
        ...
        if ($ent_id > 0) {
            ...
            $dados = $this->modelColetaManual->selectEntrevistaColetaManual("bar_nome ~* '" . $ent_barco . "'", $orderby);
       }
        elseif ($ent_apelido){
            $dados = $this->modelColetaManual->selectEntrevistaColetaManual("tp_apelido ~* '" . $ent_apelido . "'", $orderby, 20);
        }
        elseif($ent_all){
    ...
    public function editarAction(){
        ...
        $datahoraSaida[] = explode(" ",$entrevista['cml_dhsaida']);
        $datahoraVolta[] = explode(" ",$entrevista['cml_dhvolta']);
    ...
    public function mediaespeciesAction(){
        ...
        $arrayMedia = $this->modelColetaManual->selectMediaEspecies('esp_id = '.$especie);
    ...
    public function verificaespecieAction(){
        ...
        $this->redirect("/coleta-manual/mediaespecies/esp_id/" . $especie);
    }
    ...
    public function insertavistamentoAction(){
        ...
        $this->redirect("/coleta-manual/tableavistamento/id/" . $idEntrevista);
    }
    public function deleteavistamentoAction(){
        $this->_helper->layout->disableLayout();
        $this->_helper->viewRenderer->setNoRender(true);

        $idAvistamento = $this->_getParam("id_entrevista_has_avistamento");
    ...
    public function tablebiocamaraoAction(){ //ACTION PARA REDIRECIONAR SEM LAYOUT
        //IMPORTANTE TER!!
        $this->_helper->layout->disableLayout();
    ...
    public function insertbiocamaraoAction() {
        ...
        $this->redirect("/coleta-manual/tablebiocamarao/id/" . $idEntrevista);
    }
    public function deletebiocamaraoAction() {
        ...
        $this->modelColetaManual->deleteBioCamarao($idEntrevistaHasBioCamarao);
    ...
    public function deletebiopeixeAction() {
        ...
        $this->modelColetaManual->deleteBioPeixe($idEntrevistaHasBioPeixe);
