...
class MergulhoController extends Zend_Controller_Action
{
    ...
    public function updatepesqueiroAction() {
        ...
        $this->modelMergulho->updatePesqueiro($idEntrevistaPesqueiro, $idEntrevista, $pesqueiro, $tempoapesqueiro, $distanciapesqueiro);
        $this->redirect("/mergulho/tablepesqueiro/id/" . $idEntrevista);
        }
    ...
    public function mediaespeciesAction(){
        ...
        $arrayMedia = $this->modelMergulho->selectMediaEspecies('esp_id = '.$especie);
    ...
    public function verificaespecieAction(){
        ...
        $this->redirect("/mergulho/mediaespecies/esp_id/" . $especie);
    }
    ...
    public function insertavistamentoAction(){
        ...
        $this->redirect("/mergulho/tableavistamento/id/" . $idEntrevista);
    }
    public function deleteavistamentoAction(){
        ...
        $this->modelMergulho->deleteAvistamento($idEntrevistaHasAvistamento, $idEntrevista);
...
//$this->redirect("/arrasto-fundo/editar/id/" . $backUrl);
    ...
    public function deletebiocamaraoAction() {
        ...
        $this->modelMergulho->deleteBioCamarao($idEntrevistaHasBioCamarao);
    ...
    public function insertbiopeixeAction() {
        ...
        $this->modelMergulho->insertBioPeixe($idEntrevista, $idEspecie, $sexo, $comprimento, $peso);
    ...
    public function deletebiopeixeAction() {
        ...
        $this->modelMergulho->deleteBioPeixe($idEntrevistaHasBioPeixe);
