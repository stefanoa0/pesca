...
class ArrastoFundoController extends Zend_Controller_Action {
    ...
    public function editarAction() {
        ...
        //$this->view->assign('medias', json_encode($arrayMedias, JSON_FORCE_OBJECT));
    ...
    public function updatepesqueiroAction() {
        ...
        $this->modelArrastoFundo->updatePesqueiro($idEntrevistaPesqueiro, $idEntrevista, $pesqueiro, $tempoapesqueiro);
        $this->redirect("/arrasto-fundo/tablepesqueiro/id/" . $idEntrevista);
     }
    ...
    public function updatebiocamaraoAction() {
        ...
        $peso = $this->_getParam("peso");
//$backUrl = $this->_getParam("back_url");
        $this->modelArrastoFundo->updateBioCamarao($idRelacao, $idEntrevista, $idEspecie, $sexo, $maturidade, $compCabeca, $peso);
//$this->redirect("/arrasto-fundo/editar/id/" . $backUrl);
        $this->redirect("/arrasto-fundo/tablebiocamarao/id/" . $idEntrevista);
    }
