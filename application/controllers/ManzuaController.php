...
public function visualizarAction() {
    ...
    public function updatepesqueiroAction() {
        ...
        $this->modelManzua->updatePesqueiro($idEntrevistaPesqueiro, $idEntrevista, $pesqueiro, $tempoapesqueiro, $distanciapesqueiro);
        $this->redirect("/manzua/tablepesqueiro/id/" . $idEntrevista);
        }
    ...
    public function mediaespeciesAction(){
        ...
        $arrayMedia = $this->modelManzua->selectMediaEspecies('esp_id = '.$especie);
    ...
    public function verificaespecieAction(){
        ...
        $this->redirect("/manzua/mediaespecies/esp_id/" . $especie);
    }
...
//$this->redirect("/arrasto-fundo/editar/id/" . $backUrl);
    ...
    public function updatebiopeixeAction() {
        ...
        $this->modelManzua->updateBioPeixe($idEntrevistaPeixe,$idEntrevista, $idEspecie, $sexo, $comprimento, $peso);
        //$this->redirect("/manzua/editar/id/" . $backUrl);
        $this->redirect("/manzua/tablebiopeixe/id/" . $idEntrevista);
        }
