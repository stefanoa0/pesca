...
private $usuario;
    ...
    public function indexAction()
    {
        ...
        if($idBarco){
            $this->redirect('tarrafa/pescadores/id/'.$fichadiaria['fd_id'].'/idMonitoramento/'.$monitoramento['fd_id'].'/bar_id/'.$idBarco);
        }
    }
    ...
    public function pescadoresAction(){
        ...
        $pescadores = $this->modelTarrafa->selectPescadoresByBarco('bar_id = '.$idBarco, 'tp_nome');
        if(empty($pescadores)){
            $pescadores = $this->modelPescador->select(null, 'tp_nome');
        }
    ...
    public function updateespeciecapturadaAction() {
        ...
        $this->modelTarrafa->updateEspCapturada($idEntrevistaEspecie,$idEntrevista, $especie, $quantidade, $peso, $preco);
        $this->redirect("/tarrafa/tableespcaptura/id/" . $idEntrevista);
        }
    ...
    public function updatebiocamaraoAction() {
        ...
        $peso = $this->_getParam("peso");
//$backUrl = $this->_getParam("back_url");
        $this->modelTarrafa->updateBioCamarao($idRelacao, $idEntrevista, $idEspecie, $sexo, $maturidade, $compCabeca, $peso);
